...
- [ ] **Rarity ladder rename** (cosmetic cleanup): `legendary`→`unique`, drop/fold `epic`, save-migrate old rarity ids. *(deferred — the mechanics already match D2; this is a naming pass.)*
