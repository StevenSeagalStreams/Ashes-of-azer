...
- [ ] **Runewords**: an ordered rune sequence in a matching socketed base spells a runeword — fixed powers that override the individual rune stats (the D2 chase). *(next box, building on sockets.)*
